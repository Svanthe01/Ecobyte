<%--
    Document   : ListaRecicladoras
    Created on : 02-ene-2020, 23:07:48
    Author     : dante
--%>
...
<html>
    ...
    <body>
        <table id="Tablita">
            <th style="float:left; padding: 8px;">Compra de residuos</th>
            ...
            <%
                ...
                try{
                    ps = con.prepareStatement("SELECT * FROM c_empresas WHERE tipo LIKE 'v'");
                    rs = ps.executeQuery();
                    while(rs.next()){
                    %>
                    <tr>
